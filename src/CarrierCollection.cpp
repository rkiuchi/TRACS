                                        ...
                                        int &totalCrosses, const std::string &scanType)
{
    ...
    //std::cout << "Before simulate_drift : _queue_carrier_list.size() = " << _queue_carrier_list.size() << ", (*itr_queue).size() = " << (*itr_queue).size() << std::endl;
    ...
    while( continue_loop && loop < 20 )
    {
        ...
        if( !gen_carrier_list.empty() )
        {
            ...
            std::cout << "Initial number of carrier = " << initial_n_carrier << std::endl;
            std::cout << "Number of carrier generated in this loop = " << gen_carrier_list.size() << std::endl;            
            std::cout << "Total generated_n_carrier = " << generated_n_carrier << std::endl;
